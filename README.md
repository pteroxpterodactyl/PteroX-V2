...
> PteroX V2 is designed for **Pterodactyl 1.14.x**. Other Pterodactyl versions are **not guaranteed to work**.
...
>
> The installer automatically installs those files into your Pterodactyl installation.
...
The configured logo is used by the supported PteroX branding locations, including the sidebar and login page.
...
This controls the main header/login branding.
...
> Normal branding changes should be made through `pterox.config.ts`. You normally do not need to edit the individual React components.
...
```text
/var/www/pterodactyl/storage/pterox-backups/20260819-095539/
```
...
The complete customer installation and customization guide is included inside the release ZIP:
...
**Release:** `PteroX V2.0.0 STABLE`

Check the **Releases** section for the latest downloadable version.
